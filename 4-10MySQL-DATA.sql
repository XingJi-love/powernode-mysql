┌ ⠀  pwsh⠀  LAPTOP-5HCUL9AKLenovoHZB⠀                                                                            456ms · 10/04/25 13:22
└[  ]
❯ mysql -uroot -p
Enter password: ****
...
mysql> SELECT e.ename, d.dname FROM emp e JOIN dept d NO e.deptno = d.deptno;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'NO e.deptno = d.deptno' at line 1
...
mysql> select empno,ename from dept;
